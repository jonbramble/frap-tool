...
ACLOCAL = ${SHELL} /home/jon/Programming/C/frap-master/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /home/jon/Programming/C/frap-master/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jon/Programming/C/frap-master/missing --run autoheader
AUTOMAKE = ${SHELL} /home/jon/Programming/C/frap-master/missing --run automake-1.11
AWK = mawk
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/jon/Programming/C/frap-master/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
TIFF_LIBS = -ltiff
VERSION = 0.1
abs_builddir = /home/jon/Programming/C/frap-master
abs_srcdir = /home/jon/Programming/C/frap-master
abs_top_builddir = /home/jon/Programming/C/frap-master
abs_top_srcdir = /home/jon/Programming/C/frap-master
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/jon/Programming/C/frap-master/install-sh
...
install-nobase_fraptool_includeHEADERS: $(nobase_fraptool_include_HEADERS)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(fraptool_includedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(fraptool_includedir)" || exit 1; \
	fi; \
...
install-nodist_fraptool_libincludeHEADERS: $(nodist_fraptool_libinclude_HEADERS)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(fraptool_libincludedir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(fraptool_libincludedir)" || exit 1; \
	fi; \
	for p in $$list; do \
	  if test -f "$$p"; then d=; else d="$(srcdir)/"; fi; \
	  echo "$$d$$p"; \
