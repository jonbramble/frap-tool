...
/* #undef HAVE_IOSTREAM_ */

/* Define to 1 if you have the <memory.h> header file. */
#define HAVE_MEMORY_H 1

/* Define to 1 if you have the <plplot/plstream.h> header file. */
#define HAVE_PLPLOT_PLSTREAM_H 1
...
#define PACKAGE_URL "http://mpi.leeds.ac.uk/software/frap"
