...
AMTAR = ${SHELL} /home/DS/phyjpb/Programming/C/frap-tool/missing --run tar
...
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
PLPLOT_LIBS = -lplplotcxxd -lltdl -ldl -lcsirocsa -lcsironn -lqhull -lqsastime -lfreetype
SET_MAKE = 
SHELL = /bin/bash
STRIP = 
TIFF_LIBS = -ltiff
...
FRAP_SOURCES = include/frap.h include/selection.h include/fitting.h include/tiffile.h src/tiffile.cc src/frap.cc src/selection.cc src/fitting.cc src/main.cc src/chart.cc
all: config.h
...
FRAP$(EXEEXT): $(FRAP_OBJECTS) $(FRAP_DEPENDENCIES) 
	@rm -f FRAP$(EXEEXT)
